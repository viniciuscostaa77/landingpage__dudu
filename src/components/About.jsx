    ...
    <section id="sobre" className="container-px py-20 sm:py-28">
      <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-20">
        <div className="relative mx-auto w-full max-w-sm lg:mx-0">
          ...
          <img
            src="public/foto_nova.png"
            alt={`${profissional.nome}, ${profissional.profissao}`}
            className="relative w-full rounded-xl2 object-cover shadow-card aspect-[3/4]"
          />
          <div className="absolute -left-6 bottom-8 hidden rounded-xl2 bg-forest-950 px-5 py-4 text-cream-50 shadow-soft sm:block">
            <p className="flex items-center gap-2 text-xs text-cream-50/70">
              <MapPin className="h-3.5 w-3.5 text-lime-400" /> {profissional.cidade}
            </p>
          </div>
        </div>

        <div>
          <span className="eyebrow text-forest-700">Sobre o profissional</span>
          ...
          <p className="mt-6 flex items-start gap-2 text-sm text-ink-700">
            <GraduationCap className="mt-0.5 h-4 w-4 shrink-0 text-forest-700" />
            {profissional.formacao}
          </p>

          <p className="mt-6 max-w-xl text-ink-700">
            Com atuação dedicada à saúde e performance, junto meu olhar clínico de
            nutricionista à experiência prática de personal trainer para montar
            estratégias reais — que cabem na sua rotina e evoluem com você. Nada
            de fórmulas prontas: cada plano nasce da sua avaliação.
          </p>
          ...
          <div className="mt-9">
            <WhatsappButton mensagem={whatsappMessages.geral} variant="outline">
