  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? 'bg-cream-50/90 backdrop-blur-md shadow-card' : 'bg-transparent'
      }`}
    >
      <div className="container-px flex h-20 items-center justify-between">
        <a href="#inicio" className="flex items-center gap-2.5 shrink-0">
          ...
          <span className="font-display text-xl uppercase tracking-tight text-forest-950">
            ...
            <span className="text-forest-700">.{profissional.nome.split(' ')[1]?.[0]}</span>
          </span>
        </a>
        ...
        <div className="hidden lg:block">
          <WhatsappButton mensagem={whatsappMessages.geral}>Falar no WhatsApp</WhatsappButton>
        </div>
